...
namespace ColorLand
{
    ...
    public class Camera
    {
        ...
        private const int CAMERA_START_DESTINY_X = Game1.sHALF_SCREEN_RESOLUTION_WIDTH;
        private const int CAMERA_START_DESTINY_Y = Game1.sHALF_SCREEN_RESOLUTION_HEIGHT;
