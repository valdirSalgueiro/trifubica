        ...
        public override void update(GameTime gameTime)
        {
            ...
            if (!Game1.sKINECT_BASED)
            {
                ...
                //{
                    ...
                    setLocation((mouseState.X / Game1.screenScalingFactor.X + GamePlayScreen.sCURRENT_STAGE_X_PROGRESSIVE)-40, mouseState.Y / Game1.screenScalingFactor.Y -40); //half half image
