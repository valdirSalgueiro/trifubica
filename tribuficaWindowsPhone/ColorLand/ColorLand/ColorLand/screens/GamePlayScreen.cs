    ...
    public class GamePlayScreen : BaseScreen
    {
        ...
        * *************/
        ...
        private void loadStage(int stage)
        {
            ...
            mMainCharacter.setCenter(Game1.sSCREEN_RESOLUTION_WIDTH / 2, 500);
            ...
            switch (mCurrentStage)
            {
                ...
                case sSTAGE_3:
                    ...
                    mMainCharacter.setCenter(Game1.sSCREEN_RESOLUTION_WIDTH / 2, 520);
                ...
                case sSTAGE_4:
                    ...
                    */
                    ...
                    mMainCharacter.setCenter(Game1.sSCREEN_RESOLUTION_WIDTH / 2, 508);
        ...
        null,
        null,
        mCamera.get_transformation(Game1.getInstance().GraphicsDevice)*Game1.globalTransformation);
            switch (mGameState)
            {
                case GAME_STATE_PREPARANDO:
        ...
        mCamera.get_transformation(Game1.getInstance().GraphicsDevice)*Game1.globalTransformation);
            ...
            else if (background == mBackgroundFront)
            {
        ...
        public void incrementProgress()
        {
            ...
            mBackgroundBack.saturateAll(porcentagemRestante);
            mBackgroundFront.saturateAll(porcentagemRestante);
